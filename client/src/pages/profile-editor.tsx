...
export default function ProfileEditor() {
  ...
  // Use the real server ID from MongoDB data
  const serverId = "719536686140227674"; // Real server ID from MongoDB
  
  console.log('ProfileEditor - Using server ID:', serverId);
